// Main application logic for Task Scheduler - Offline Version
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderScheduleTimeline() {
        ...
        state.schedule.forEach(activity => {
            ...
            const startDateStr = activity.startDate.toLocaleString();
            const endDateStr = activity.endDate.toLocaleString();
